...
TEXT = {
    ...
    'can_search': 'Также вы можете воспользоваться поисков, сказав название теста',
    ...
    'end_test': 'Если хотите пройти заново, назовите имя. Или скажите "Назад".',
    'start': 'Стартуем!/Поехали!/Начинаем!',
    'wanna_like': 'Если вам понравился тест, скажите "Лайк"!',
    'already_liked': 'Вы уже лайкали этот тест! Введите имя или скажите "Назад".',
    'have_liked': 'Спасибо! Введите имя или скажите "Назад".',
